...
Module FindSpec (Params: SKIP_LIST_PARAMS).
  ...
  Section proofs.
    ...
    Theorem find_spec (k: Z) (head curr: node_rep) (Γ: lazy_gname)
      ...
      <<{ ∀∀ (S: gset node_rep), lazy_list head S Γ γ lvl }>>
    ...
    Proof.
      ...
      iIntros "[Hlock ->] !>". iDestruct "Hin" as (s) "Hnext".
